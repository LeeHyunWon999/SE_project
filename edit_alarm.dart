...
class _ExampleAlarmEditScreenState extends State<ExampleAlarmEditScreen> {
  ...
  void saveAlarm() async { // 설정된 알람을 저장한다. 비동기로 'Alarm.set'을 호출하고, 성공적으로 저장되면 화면을 닫는다.
    setState(() => loading = true);
    final alarmSettings = await buildAlarmSettings();
    print("Alarm Time : ${alarmSettings.dateTime}");

    await Alarm.set(alarmSettings: buildAlarmSettings()).then((check) {
        print("Alarm Setting");
